...
// TODO: extract element text with $.text()
// TODO: extract element value with $.val()
(function () {
  var utils = {
  ...
  var reaper = (function() {
    ...
    function extractObject(object, parentContext) {
      ...
      if (utils.isArray(object)) {
        ...
        $(object.ctx, parentContext).each(function (i, context) {
          results.push(extractFields(object, $(context)));
        });
        ...
        if (object.ctx) {
          context = $(object.ctx, parentContext);
        }

        return extractFields(object, $(context));
      }
    }

    function extractFields(object, element) {
      var result = {};
    ...
    function extract(rule, document) {
      $ = document;
      return extractObject(rule, $('html'));
    }
